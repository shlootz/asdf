package hero 
{
	...
	public class MyHero extends Hero
	{
		...
		public function MyHero(name:String,  params:Object=null) 
		{
			...
			//this.onJump.add(swapJumpGraphics);
			//this.onAnimationChange.add(swapAnimationsGraphics);
		}
		
		/**
		 * 
		 */
		private function swapJumpGraphics():void
		{
			this.view = jumpImage;
		}
		 ...
		 * 
		 */
		private function swapAnimationsGraphics():void
		{
			if (this.onGround)
			{
				this.view = idleImage;
